...
Kickstart Guide:
  ...
  I have left several `:help X` comments throughout the init.lua
   ...
   NOTE: Look for lines like this
    ...
    for when you are first encountering a few different constructs in your Neovim config.in
...
vim.keymap.set('n', '<leader>i', ':! npm run prettier<CR>')
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>t', builtin.git_files, { desc = 'Search Gi[t] Files' })
